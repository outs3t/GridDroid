...
class StreamSettings(BaseModel):
    ...
    # stream a qualita' diversa. Tutti a 0 = DISATTIVO (nessun restart,
    # fullscreen come prima). Compilare i tre campi per attivarlo.
    focus_max_size: int = Field(default=0, ge=0, le=2800)
    focus_max_fps: int = Field(default=0, ge=0, le=60)
    focus_bit_rate: int = Field(default=0, ge=0, le=20_000_000)
